...
class Map:
    """Map handling"""
    @staticmethod
    def print_relation(relation_id, ref, route_start_point):
        ...
        folium_map.save('./routes/{}.html'.format(ref))
        return '<iframe src="./routes/{}.html"></iframe>'.format(ref)

class Routing:
    """Using graphhopper API we set a route between 2 points"""
    API_KEY = "API_KEY_HERE"
    REQUEST_URL = "https://graphhopper.com/api/1/"
    VEICHLE = "car"
    @staticmethod
    def find_best_path(point_1, point_2, ref):
